import { PersonDTO } from '@/domain/models';

/**
 * People DataSource
 * Fuente de datos estática de personas
 * Principio DRY: Datos centralizados en un solo lugar
 */
export const PeopleDataSource: PersonDTO[] = [
  {
    id: '1',
    name: 'Alan Bello',
    category: 'manager',
